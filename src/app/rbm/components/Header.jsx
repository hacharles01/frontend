      ...
      <AppBar position="static" elevation={0} className="app-bar">
        <Toolbar className="pr-2">
          ...
          <Typography component="div" sx={{ flexGrow: 1 }} className="left">
            ...
            <span className="ml-2 d-none d-md-inline text-primary text-uppercase font-weight-bold">
          ...
          {!!user.actingPosition && (
            <div className="roles text-primary  d-flex">
              <>
                ...
                {user.actingPosition.isPlanner && !user.position.isPlanner && (
                  <span className=" d-flex ">
                ...
                {user.actingPosition.isEmployee && !user.position.isEmployee && (
                  <span className=" d-flex ">
